...
<nav class="navbar navbar-default main-navigation" role="navigation">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <form id="navsearch" action="/ads" method="GET" class="form-inline float-lg-right" role="search">
                <input id="search" name="search" class="mainnav form-control" type="text" placeholder="Search">
                <button class="mainnav btn btn-common btn-search" type="submit">Go</button>
            </form>
        </div>
    </div>
</nav>